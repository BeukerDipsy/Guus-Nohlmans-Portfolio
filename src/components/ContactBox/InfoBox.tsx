...
export default function InfoBox({ title, description, svg }: { title: string, description: string, svg?: JSX.Element }) {
  return (
    <div className=" w-full h-full w-[90%] p-4 rounded-2xl bg-primaryYellow flex flex-row shadow-[0.6rem_0.6rem_0_rgba(0,0,0,0.18)]">
      <div className="h-[90%] aspect-square rounded-2xl m-auto border-2 border-primaryGreen flex items-center justify-center">
        {svg}
      </div>
