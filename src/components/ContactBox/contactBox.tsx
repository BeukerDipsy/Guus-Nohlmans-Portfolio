...
export default function ContactBox() {
  return (
    ...
    <div className="flex row">
      {/** Een grote component **/}
      <div className=" w-[68%] p-8 rounded-2xl border border-secondaryYellow bg-primaryYellow flex flex-col gap-4 mb-10 ">
        ...
        <button className="bg-secondaryYellow flex flex-row gap-2 text-secondaryGreen font-semibold p-3 rounded-md hover:bg-yellow-400 transition cursor-pointer">
          <svg fill="#214013" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" className="w-6 h-6 ml-2">
      ...
      <div className="pl-10 space-y-6 flex flex-col w-[32%]  ">
        <InfoBox title="Email" description="guus.nohlmans@gmail.com" />
