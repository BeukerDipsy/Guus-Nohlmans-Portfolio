export default function Education() {
  ...
  return (
    <div className="px-8 py-6 rounded-2xl mx-[7rem] md:mx-0 md:max-w-[40vw] w-full self-center bg-primaryYellow shadow-[0.8rem_0.8rem_0_rgba(0,0,0,0.12)] items-start h-full text-primaryGreen">
