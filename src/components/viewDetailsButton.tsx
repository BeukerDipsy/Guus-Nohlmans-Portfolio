...
export default function ViewDetailsButton({ path }: { path: string }) {
  ...
  return (
    <>
      ...
      <span className="text-secondaryGreen font-bold hover:underline hover:text-primaryGreen transition cursor-pointer flex justify-end items-center text-[2.4rem] md:text-[1.25rem]" onClick={() => router.push(`/${path.toLowerCase()}`)}>
        View details
