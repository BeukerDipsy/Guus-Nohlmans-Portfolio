    ...
    <>
      <main className="max-w-[1440px] mx-auto w-full">
        ...
        <section
          ...
          className="pb-[10vh] md:mx-0 mx-0"
        >
          <div className="flex flex-col justify-center w-full px-4 md:px-8 2xl:px-12">
            ...
            <div className=" flex w-full max-w-[95vw] flex-row justify-start gap-6 overflow-x-auto md:overflow-visible pb-2 snap-x snap-mandatory md:justify-between">
